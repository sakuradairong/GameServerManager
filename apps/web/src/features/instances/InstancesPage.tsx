  ...
  async function runAction(id: string, action: 'start' | 'stop' | 'restart' | 'delete') {
    ...
    try {
      if (action === 'delete') {
        ...
        push(`实例已${action === 'start' ? '启动' : action === 'stop' ? '停止' : '重启'}`, 'success')
              ...
              <div key={instance.id} className="table-row">
                ...
                <div className="row-actions">
                  <button
                    ...
                    onClick={() => runAction(instance.id, 'start')}
                  >
                    启动
                  </button>
                  <button
                    ...
                    disabled={busyId === instance.id}
                    onClick={() => runAction(instance.id, 'stop')}
                  >
                    停止
                  </button>
                  <button
                    ...
                    className="btn btn-ghost"
                    disabled={busyId === instance.id}
                    onClick={() => runAction(instance.id, 'restart')}
                  >
                    重启
                  </button>
                  {instance.terminalSessionId && (
